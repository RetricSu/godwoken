...
use gw_jsonrpc_types::{
    ...
    godwoken::{
        ...
        NodeRollupConfig, RollupCell, RunResult, TxReceipt, WithdrawalStatus, WithdrawalWithStatus,
    },
...
pub fn to_node_rollup_config(rollup_config: &RollupConfig) -> NodeRollupConfig {
    ...
    let reward_burn_rate: GwUint64 =
        bytes_v10::Buf::get_u64(&mut rollup_config.reward_burn_rate().as_bytes()).into();
    let compatible_chain_id: GwUint32 =
        bytes_v10::Buf::get_u32(&mut rollup_config.compatible_chain_id().as_bytes()).into();
    NodeRollupConfig {
        required_staking_capacity,
        challenge_maturity_blocks,
        finality_blocks,
